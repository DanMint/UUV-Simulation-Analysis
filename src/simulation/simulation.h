...
#include "patrolAgent.h" //  Added this needed to do ../agents/patrolAgents.h is where it lives --- making sure cmakelist.txt workes with the shorthand version had weird issue at one point
...
private:
    ...
    std::vector<PatrolDefenderAgent> m_patrolDefenders; // This section is essentilly hey were storing the patrolDefenders thats waht thsi section just says during sim
    ...
    void updatePatrolDefenders(int currentStep); 
};
